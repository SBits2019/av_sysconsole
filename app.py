...
def list_components():
    return render_template('components.html', changed_components=helper_tools.get_comp_dict())
...
def get_file_attrs(detail_component, detail_file):
    ...
    return render_template('comp_detail.html',
                           attribute_modifications=helper_tools.get_attribute_modifications(detail_component, detail_file), file_name=detail_file, changed_components=helper_tools.get_comp_dict())
